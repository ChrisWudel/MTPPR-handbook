...
In the following, further examples of the simple application of **M**ulti-**T**rait **P**oint **P**attern **R**econstruction (MTPPR) by Wudel et al. (2023) are presented. These are standard applications, meaning that reconstructions are performed without enlargements or reductions of the reconstruction pattern and without edge correction.
